          ...
          {orders.map((order) => (
            <React.Fragment key={order.id}>
              <tr style={{ borderBottom: '1px solid #f0f0f0' }}>
                ...
                <td style={{ padding: '12px 16px', direction: 'ltr' }}>
                  {order.phone}
                </td>
    ...
    <div style={{
      ...
      <aside style={{
        ...
        <div style={{ padding: '28px 24px', borderBottom: '1px solid #333' }}>
          ...
          <div style={{ fontSize: '0.55rem', letterSpacing: 4, color: '#C9A96E', marginTop: 2 }}>
            ADMIN PANEL
          </div>
        </div>
      ...
      <main style={{ flex: 1, padding: '32px', overflowY: 'auto' }}>
        {tab === 'dashboard' && (
          <>
            <h1 style={{ fontSize: '1.5rem', fontWeight: 700, marginBottom: 32 }}>
              لوحة التحكم
            </h1>
